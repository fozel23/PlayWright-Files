...
public class trendyol_01 {
    ...
    public static void main(String[] args) {
        ...
        // Sayfayı açma
        page.navigate("http://trendyol.com");
        System.out.println("title " + page.title());

        Locator logoByAltText = page.locator("img[alt='Male']");
        logoByAltText.click();

       page.getByPlaceholder("Aradığınız ürün, kategori veya markayı yazınız").fill("notebook");

       page.getByTestId("suggestion-item").nth(3).click();
